...
@section('content')
            ...
            <div class="card-title">
                ...
                <div class="my-1 d-flex align-items-center position-relative">
                    <i class="ki-duotone ki-magnifier fs-1 position-absolute ms-4"><span class="path1"></span><span
                        ...
                        class="form-control form-control-solid w-250px ps-14" placeholder="Cari Data Akreditasi">
                </div>
                <!--end::Search-->
            </div>
    ...
    @includeIf('pages.akreditas.modal')
@endsection
@push('addon-script')
    ...
    <script>
        ...
        var KTDatatablesExample = function() {
                ...
                datatable = $(table).DataTable({
                    ...
                    "columns": [{
                        ...
                        },
                        {
                            ...
                            className: 'no-export',
                            render: function(data, type, row) {
                                var baseUrl = "{{ route('akreditas.index') }}";
            ...
            // Hook export buttons
            var exportButtons = () => {
                const documentTitle = 'Akreditas Data Report';
