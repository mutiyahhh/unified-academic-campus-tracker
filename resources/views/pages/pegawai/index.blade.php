...
@section('content')
            ...
            <div class="card-title">
                ...
                <div class="my-1 d-flex align-items-center position-relative">
                    <i class="ki-duotone ki-magnifier fs-1 position-absolute ms-4"><span class="path1"></span><span
                        ...
                        class="form-control form-control-solid w-250px ps-14" placeholder="Cari Data Pegawai">
                </div>
                <!--end::Search-->
            </div>
    ...
    @includeIf('pages.pegawai.modal')
    @includeIf('pages.pegawai.detail')
@endsection
@push('addon-script')
        ...
        $(document).on('click', '.detail-btn', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#work_bond").text(response.work_bond);
                    $("#active_status").text(response.active_status);
    ...
    <script>
        ...
        var KTDatatablesExample = function() {
                ...
                datatable = $(table).DataTable({
                    ...
                    "columns": [{
                        ...
                        },
                        {
                            ...
                            className: 'no-export',
                            render: function(data, type, row) {
                                var baseUrl = "{{ route('pegawai.index') }}";
            ...
            // Hook export buttons
            var exportButtons = () => {
                const documentTitle = 'Pegawai Data Report';
